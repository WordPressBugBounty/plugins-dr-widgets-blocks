 ...
 *
 * This template can be overridden by copying it to yourtheme/dr-widgets-blocks/recipe-carousels-two.php.
 *
...
$overlap_class = $settings['layout'] === 'layout-2' ? 'dr-recipe-carousel-2__overlap--stack' : '';
