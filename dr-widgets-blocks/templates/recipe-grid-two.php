 ...
 *
 * This template can be overridden by copying it to yourtheme/dr-widgets-blocks/recipe-grid-two.php.
 *
...
<div class="dr_column">
	<div class="dr-widgetBlock_recipe-post">
		...
		<div class="dr-widgetBlock_content-wrap">
			...
			if ( 'layout-3' === $settings['layout'] ) {
				echo '<div class="meta-wrapper"><div class="inner-wrapper">';
			}
