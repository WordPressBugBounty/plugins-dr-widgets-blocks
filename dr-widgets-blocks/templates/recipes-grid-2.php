 ...
 *
 * This template can be overridden by copying it to yourtheme/dr-widgets-blocks/recipes-grid-2.php.
 *
...
$image_alignment_class = 'dr_image-' . $settings['image_alignment'];
$show_readmore_arrow   = $settings['show_readmore_arrow'] ? 'dr_icon-right' : '';

?>
<div class="dr_column">
	<div class="dr-widgetBlock_recipe-post l2rp <?php echo esc_attr( $image_alignment_class ); ?>">
		...
		<div class="dr-widgetBlock_content-wrap">
			...
			<?php if ( $settings['show_excerpt'] && $recipe_metas->excerpt ) : ?>
				...
				<div class="dr_button-wrap">
					<?php if ( $settings['show_readmore'] ) : ?>
						<a href="<?php echo esc_url( $recipe_metas->permalink ); ?>" class="dr_read-more <?php echo esc_attr( $show_readmore_arrow ); ?>">
