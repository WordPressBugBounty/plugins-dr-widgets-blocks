 ...
 *
 * This template can be overridden by copying it to yourtheme/dr-widgets-blocks/recipes-grid-module-two.php.
 *
...
$image_size = ( $count == 0 || $settings['layout'] === 'layout-3' && $count == 1 ) ? $settings['hero_image_size'] : $settings['image_size'];

?>
	<div class="dr-grid-2__recipe 
	<?php
	if ( $count == 0 || $settings['layout'] === 'layout-3' && $count == 1 ) {
		echo 'dr-grid-2__recipe--hero';
	} else {
		echo 'dr-grid-2__recipe--regular';
	}
	?>
	">
		<div class="dr-grid-2__module-two">
			...
			<div class="dr-widgetBlock_content-wrap">
				<?php if ( ( $settings['layout'] == 'layout-2' && $count !== 2 && $count !== 3 ) || $settings['layout'] == 'layout-1' || $settings['layout'] == 'layout-3' ) { ?>
				...
				<?php if ( ( ( $settings['layout'] == 'layout-2' && $count !== 2 && $count !== 3 ) || $settings['layout'] == 'layout-1' || $settings['layout'] == 'layout-3' ) && ! empty( $recipe_metas->recipe_keys ) && $settings['show_recipe_keys'] ) : ?>
