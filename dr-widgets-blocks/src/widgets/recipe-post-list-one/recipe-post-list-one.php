...
class Widget_Recipe_Post_List_One extends Widget {
	...
	public function get_script_depends()	{
		wp_register_script( 'drWidgets-recipe-post-list-one', plugin_dir_url( DR_WIDGETS_BLOCKS_PLUGIN_FILE ) . 'src/widgets/recipe-post-list-one/recipe-post-list-one.js', array( 'jquery' ), DR_WIDGETS_BLOCKS_VERSION, true );

		// Generate nonce
		wp_localize_script('drWidgets-recipe-post-list-one', 'recipePostListOne', array(
			'nonce' => wp_create_nonce('recipe_post_list_one_nonce')
		));

		return array( 'drWidgets-recipe-post-list-one');
	}
	...
	protected function register_controls() {
		...
		/**
		 * Recipe Post List One Pagination Section
		 */
		$this->start_controls_section(
			'pagination_section',
			array(
