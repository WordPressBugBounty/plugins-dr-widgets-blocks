...
class Widget_Recipe_Post_List_Two extends Widget {
	...
	public function get_script_depends()	{
		wp_register_script( 'drWidgets-recipe-post-list-two', plugin_dir_url( DR_WIDGETS_BLOCKS_PLUGIN_FILE ) . 'src/widgets/recipe-post-list-two/recipe-post-list-two.js', array( 'jquery' ), DR_WIDGETS_BLOCKS_VERSION, true );

		// Generate nonce
		wp_localize_script('drWidgets-recipe-post-list-two', 'recipePostListTwo', array(
			'nonce' => wp_create_nonce('recipe_post_list_two_nonce')
		));

		return array( 'drWidgets-recipe-post-list-two');
	}
	...
	protected function register_controls() {
		...
		/**
		 * Recipe Post List Two Pagination Section
		 */
		$this->start_controls_section(
			'pagination_section',
			array(
