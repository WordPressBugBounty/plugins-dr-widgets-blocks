...
(function ($) {
    jQuery(window).on('elementor/frontend/init', () => {
        class PaginationHandler extends elementorModules.frontend.handlers.Base {
            ...
            initPagination() {
                let containerID = document.querySelectorAll('.elementor-widget-dr-recipe-post-list-two');
            ...
            fetchRecipes(dataSettings, taxonomy, terms, pagedValue, elementID, append, callback = () => {}) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    data: {
                        action: 'dr_widgets_blocks_recipe_post_list_two',
                        nonce: recipePostListTwo.nonce,
                        paged: pagedValue,
        ...
        elementorFrontend.elementsHandler.attachHandler('dr-recipe-post-list-two', PaginationHandler);
    });
})(jQuery);