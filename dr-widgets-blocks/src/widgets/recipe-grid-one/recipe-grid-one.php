...
class Widget_Recipe_Grid_One extends Widget {
	...
	protected function render() {
		...
		?>
		<div class="dr-widget">
			<div class="dr-widgetBlock_row recipe-grid-post-one <?php echo esc_attr( $layout ); ?> columns-<?php echo esc_attr( $per_row_tablet ); ?>-tb columns-<?php echo esc_attr( $per_row_mobile  ); ?>-mb columns-<?php echo esc_attr( $per_row ); ?>">
				<?php
				if ( $recipes_query->have_posts() ) {
					while ( $recipes_query->have_posts() ) {
						...
						dr_widgets_blocks_get_template( 'recipe-grid-one.php', $data );
					}
					wp_reset_postdata();
				}
				?>
