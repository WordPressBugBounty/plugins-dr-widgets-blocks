...
class Widget_Recipe_Posts extends Widget {
	/**
	 * @var $widget_name
	 */
	public $widget_name = 'dr-recipe-posts';

	public function get_title() {
		return esc_html__( 'Recipe Posts', 'dr-widgets-blocks' );
	}

	public function get_icon() {
		return 'icon-recipe-post';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label'        => esc_html__( 'Read More', 'dr-widgets-blocks' ),
				'label_on'     => esc_html__( 'Show', 'dr-widgets-blocks' ),
				'label_off'    => esc_html__( 'Hide', 'dr-widgets-blocks' ),
				'return_value' => 'yes',
				'default'      => '',
		...
		$this->add_control(
			...
			array(
				...
				'label'       => esc_html__( 'Read more text', 'dr-widgets-blocks' ),
				'placeholder' => esc_html__( 'Read more', 'dr-widgets-blocks' ),
				'default'     => esc_html__( 'Read more', 'dr-widgets-blocks' ),
				'condition'   => array(
					'showReadmore' => 'yes',
				),
			)
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .dr-widgetBlock_recipe-post.l2rp, {{WRAPPER}} .dr-widgetBlock_recipe-post.l3rp, {{WRAPPER}} .dr-widgetBlock_recipe-post.l1rp .dr-widgetBlock_fig-wrap',
			)
		);
		$this->add_responsive_control(
			'alignment',
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .dr-widgetBlock_recipe-post, {{WRAPPER}} .dr-widget .dr-widgetBlock_content-wrap' => 'text-align: {{VALUE}};',
				),
			)
		);
		$this->end_controls_section();
		...
		*/
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .dr-widget .dr-widgetBlock_recipe-post .dr_recipe-keys' => 'text-align: {{VALUE}};',
				),
			)
		);
		$this->end_controls_section();
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .dr-widget .dr_recipe-cats' => 'text-align: {{VALUE}};',
				),
			)
		);
		$this->end_controls_section();
		...
		/**
		 * Recipe Posts Read More Button Style Section for Normal and Hover state
		 * */
		$this->start_controls_section(
			'read_more_button_style_section',
			array(
				'label'     => esc_html__( 'Read More Button', 'dr-widgets-blocks' ),
				'tab'       => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => array(
					'showReadmore' => 'yes',
				),
		...
		$this->add_control(
			'showReadMoreArrow',
			array(
				'label'        => esc_html__( 'Read More Arrow', 'dr-widgets-blocks' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .dr_button-wrap .dr_read-more' => 'color: {{VALUE}};',
				),
			)
		);
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .dr_button-wrap .dr_read-more' => 'background-color: {{VALUE}};',
				),
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Border::get_type(),
			array(
				'name'     => 'readMoreButtonBorder',
				'label'    => esc_html__( 'Border', 'dr-widgets-blocks' ),
				'selector' => '{{WRAPPER}} .dr_button-wrap .dr_read-more',
			)
		);
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .dr_button-wrap .dr_read-more' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		$this->add_group_control(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .dr_button-wrap .dr_read-more' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .dr_button-wrap .dr_read-more' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .dr_button-wrap .dr_read-more:hover' => 'color: {{VALUE}};',
				),
			)
		);
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .dr_button-wrap .dr_read-more:hover' => 'background-color: {{VALUE}};',
				),
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Border::get_type(),
			array(
				'name'     => 'readMoreButtonHoverBorder',
				'label'    => esc_html__( 'Border', 'dr-widgets-blocks' ),
				'selector' => '{{WRAPPER}} .dr_button-wrap .dr_read-more:hover',
			)
		);
		$this->add_responsive_control(
			'readMoreButtonHoverBorderRadius',
			array(
				'label'      => esc_html__( 'Border Radius', 'dr-widgets-blocks' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .dr_button-wrap .dr_read-more:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Box_Shadow::get_type(),
			array(
				'name'     => 'readMoreButtonHoverBoxShadow',
				'label'    => esc_html__( 'Box Shadow', 'dr-widgets-blocks' ),
				'selector' => '{{WRAPPER}} .dr_button-wrap .dr_read-more:hover',
			)
		);
		$this->add_responsive_control(
			'readMoreButtonHoverPadding',
			array(
				'label'      => esc_html__( 'Padding', 'dr-widgets-blocks' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .dr_button-wrap .dr_read-more:hover' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		$this->add_responsive_control(
			'readMoreButtonHoverMargin',
			array(
				'label'      => esc_html__( 'Margin', 'dr-widgets-blocks' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .dr_button-wrap .dr_read-more:hover' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .dr_button-wrap' => 'text-align: {{VALUE}};',
				),
			)
		);
		$this->end_controls_section();
	...
	protected function render() {
		...
		$show_readmore       = isset( $settings['showReadmore'] ) && 'yes' === $settings['showReadmore'] ? true : false;
		$readmore_text       = isset( $settings['readmoreText'] ) ? $settings['readmoreText'] : esc_html__( 'Read More', 'dr-widgets-blocks' );
		$show_readmore_arrow = isset( $settings['showReadMoreArrow'] ) && 'yes' === $settings['showReadMoreArrow'] ? true : false;
