!function(_){"use strict";let e=null,t;async function l(){let _=await (await fetch("https://wpdeliciousdemo.com/widgets-blocks-demo/wp-json/delisho-elementor-templates/v1/patterns/")).json(),e={},t={};for(let l of _)l.meta&&l.meta.required_plugins&&(e[l.id]=l.meta.required_plugins),l.meta&&(t[l.id]="1"===l.meta.freevspro);return[e,t]}function a(_=null){return`
